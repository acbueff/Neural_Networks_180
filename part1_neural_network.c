...
#define Criteria     0.7    /* all outputs must be within this to terminate  */
#define TestCriteria 0.9    /* all outputs must be within this to generalize */
#define MaxIterate   200000000  /* maximum number of iterations                */
#define ReportIntv   100000   /* print report every time this many cases done*/
#define Momentum     0.5     /* momentum constant                             */
...
#define NumNodes2    22       /* col 2 - hidden layer 1, etc.    */
#define NumNodes3    22       /* output layer must equal NumOUTs */
#define NumNodes4    22       /*                                 */
